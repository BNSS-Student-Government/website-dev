export default function Member({ name, position }: {name: string, position: string}){
    ...
    return (
      <div className="flex flex-col justify-center items-center w-36 md:w-64 opacity-0 intersect:animate-fade" >
        <img className="size-32 md:size-40 hover:scale-105 transition-all rounded-full object-cover border-4 border-solid border-foreground opacity-0 intersect:animate-fade" src={img} alt="Avatar" />
